...
| <a name="input_subscriber_email_addresses"></a> [subscriber\_email\_addresses](#input\_subscriber\_email\_addresses) | E-Mail addresses to notify. | `set(string)` | <pre>[<br>  ""<br>]</pre> | no |
